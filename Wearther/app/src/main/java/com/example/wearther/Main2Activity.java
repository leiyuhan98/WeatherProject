...
public class Main2Activity extends Activity implements OnScrollListener,
    ...
    private void checkPermission() {
        ...
        try {
            //检测是否有写的权限
            int permission = ActivityCompat.checkSelfPermission(Main2Activity.this,
                    "android.permission.WRITE_EXTERNAL_STORAGE");
            if (permission != PackageManager.PERMISSION_GRANTED) {
                // 没有写的权限，去申请写的权限，会弹出对话框
                ActivityCompat.requestPermissions(Main2Activity.this, PERMISSIONS_STORAGE, REQUEST_EXTERNAL_STORAGE);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        while (c.moveToNext()) {
            ...
            myIntent.setClass(Main2Activity.this, NoteEdit.class);
